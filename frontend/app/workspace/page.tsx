...
import { Menu, X, AlertTriangle, LayoutDashboard, Loader2 } from "lucide-react";
...
function WorkspaceContent() {
  ...
  const rawBlueprint = startup?.blueprint ?? null;
  const blueprint = normalizeBlueprint(rawBlueprint) || undefined;
  const isLoading = startupLoading;
