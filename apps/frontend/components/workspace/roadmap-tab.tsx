...
const statusConfig = {
  done: { color: "text-emerald-400", label: "Done", badge: "success" as const },
  "in-progress": { color: "text-blue-400", label: "In Progress", badge: "default" as const },
  planned: { color: "text-muted-foreground", label: "Planned", badge: "outline" as const },
};

export function RoadmapTab({ blueprint }: { blueprint?: StartupBlueprint | null }) {
  if (!blueprint) {
    return (
      <EmptyState icon={Map} title="No roadmap yet" description="Complete the founder interview to see your product roadmap." actionLabel="Start Interview" actionHref="/interview" />
    );
  }
      ...
      <div className="relative">
        ...
        <div className="space-y-8">
          {roadmap.map((quarter, qi) => (
            <div key={quarter.quarter} className="relative pl-14">
              ...
              <div className="flex items-center gap-3 mb-4">
                <h2 className="text-lg font-bold">{quarter.quarter}</h2>
