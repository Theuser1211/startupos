        ...
        <section className="relative py-24 md:py-32 px-6 overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-4xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center mb-16">
              ...
              <h1 className="text-4xl md:text-5xl font-display font-bold tracking-tight mb-4">Your Data, Your Control</h1>
            ...
            <div className="space-y-8">
              {sections.map((section, i) => (
                <motion.div
                  ...
                  className="rounded-2xl border border-glass-border bg-glass-bg backdrop-blur-xl p-8"
                >
            ...
            <motion.div
              ...
              className="mt-12 rounded-2xl border border-glass-border bg-glass-bg backdrop-blur-xl p-8 text-center"
            >
              <p className="text-sm text-muted-foreground">
                Have questions about privacy?{" "}
                <a href="mailto:privacy@startupos.ai" className="text-purple-400 hover:underline">privacy@startupos.ai</a>
              </p>
            </motion.div>
          </div>
        </section>
